...
/**
 * Created by Murali on 11/01/2016.
 */
...
public class CustomLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    private static void onMakeInsertDirtyFailed() {
        ...
        if (BuildConfig.DEBUG) {
            Log.w("CustomLayoutManager", "Can't make LayoutParams insets dirty, decorations measurements might be incorrect");
        }
    }
    ...
    private void logMeasureWarning(int child) {
        if (BuildConfig.DEBUG) {
            Log.w("CustomLayoutManager", "Can't measure child #" + child + ", previously used dimensions will be reused." +
    ...
    private void measureChild(RecyclerView.Recycler recycler, int position, int widthSize, int heightSize, int[] dimensions) {
        ...
        try {
            ...
            if (BuildConfig.DEBUG) {
                Log.w("CustomLayoutManager", "CustomLayoutManager doesn't work well with animations. Consider switching them off", e);
            }
            return;
        }
